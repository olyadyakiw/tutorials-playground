            ...
            <div className="grid grid-cols-3 gap-2 mb-2">
                {images.map(image => (
                    <div
                        key={image.id}
                        className={cn(
                            'cursor-pointer relative aspect-video group hover:opacity-85 transition bg-muted',
                    ...
                    >
                        ...
                        />
                        <Image fill alt="Image" className="object-cover rounded-sm" src={image.urls.thumb} />
