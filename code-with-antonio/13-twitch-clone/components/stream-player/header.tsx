...
const Header = ({ imageUrl, hostIdentity, hostName, viewerIdentity, isFollowing, name }: HeaderProps) => {
                ...
                <div className="space-y-1">
                    ...
                    {isLive ? (
                        <div className="font-semibold flex gap-x-1 items-center text-xs text-rose-500">
                            ...
                            <p>
                                {participantCount} {participantCount === 1 ? 'viwever' : 'viewers'}
                            </p>
                        </div>
                    ) : (
