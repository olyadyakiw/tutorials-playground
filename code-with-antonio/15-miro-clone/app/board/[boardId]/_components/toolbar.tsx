import { Circle, MousePointer2, Pencil, Redo2, Square, StickyNote, Type, Undo } from 'lucide-react'
...
const Toolbar = ({ canRedo, canUndo, canvasState, setCanvasState, redo, undo }: ToolbarProps) => {
    return (
        <div className="absolute top-[50%] -translate-y-[50%] left-2 flex flex-col gap-y-4">
            ...
            <div className="bg-white rounded-md p-1.5 flex gap-y-1 flex-col items-center shadow-md">
                <ToolButton label="Undo" icon={Undo} onClick={undo} isDisabled={!canUndo} />
