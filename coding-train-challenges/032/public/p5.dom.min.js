...
;(!(function (t, e) {
        ...
        return (
            ...
            r.addEventListener('loadedmetadata', function () {
                ;((l.width = r.videoWidth),
                    ...
                    0 === l.elt.width && (l.elt.width = r.videoWidth),
                    0 === l.elt.height && (l.elt.height = r.videoHeight),
                    l.presetPlaybackRate && ((l.elt.playbackRate = l.presetPlaybackRate), delete l.presetPlaybackRate),
                    (l.loadedmetadata = !0))
            }),
            l
        )
    ...
    ;(['div', 'p', 'span'].forEach(function (i) {
        ...
        (d.prototype.createRadio = function (t) {
            ...
            var r,
                ...
                o = 0
            if (1 < e.length)
                for (var i = e.length, s = e[0].name, a = e[1].name, l = (o = 1); l < i; l++)
                    (s !== (a = e[l].name) && o++, (s = a))
            else 1 === e.length && (o = 1)
            ;('object' == typeof t
                ...
                arguments[r] === d.prototype.VIDEO
                    ...
                    : arguments[r] === d.prototype.AUDIO
                      ...
                      : 'object' == typeof arguments[r]
                        ? (t = arguments[r])
                        : 'function' == typeof arguments[r] && (i = arguments[r])
        ...
        (d.Element.prototype.addClass = function (t) {
            return (
                this.elt.className ? (this.elt.className = this.elt.className + ' ' + t) : (this.elt.className = t),
                this
            )
        }),
        ...
        (d.Element.prototype.center = function (t) {
            ...
            return (
                'both' === t || void 0 === t
                    ...
                    : 'horizontal' === t
                      ? this.position(o / 2, a)
                      : 'vertical' === t && this.position(l, s / 2),
        ...
        (d.Element.prototype.html = function () {
            return 0 === arguments.length
                ? this.elt.innerHTML
                : (arguments[1] ? (this.elt.innerHTML += arguments[0]) : (this.elt.innerHTML = arguments[0]), this)
        }),
        ...
        (d.Element.prototype.style = function (t, e) {
            if (
                (e instanceof d.Color &&
                    (e = 'rgba(' + e.levels[0] + ',' + e.levels[1] + ',' + e.levels[2] + ',' + e.levels[3] / 255 + ')'),
                void 0 === e)
            ) {
        ...
        (d.Element.prototype.size = function (t, e) {
            ...
            if (i !== r || n !== r) {
                if (
                    (i === r ? (i = (e * this.width) / this.height) : n === r && (n = (t * this.height) / this.width),
                    ...
                    this.elt.setAttribute('style', 'width:' + i + 'px; height:' + n + 'px'),
        ...
        (d.MediaElement.prototype.get = function (t, e, i, n) {
            if (this.loadedmetadata) {
                ...
                return (
                    this._pixelsTime !== r ? this.loadPixels() : this._ensureCanvas(),
                    d.Renderer2D.prototype.get.call(this, t, e, i, n)
                )
            }
        ...
        (d.MediaElement.prototype.connect = function (t) {
            ...
            ;(this.audioSourceNode ||
                ((this.audioSourceNode = e.createMediaElementSource(this.elt)), this.audioSourceNode.connect(i)),
                t
                    ? t.input
    ...
    (p5.File._load = function (t, e) {
        if (/^text\//.test(t.type)) p5.File._createLoader(t, e).readAsText(t)
