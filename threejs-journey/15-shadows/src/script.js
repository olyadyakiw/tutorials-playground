...
spotLight.shadow.camera.fov = 1024
...
const tick = () => {
    ...
    sphereShadow.scale.x = Math.abs(Math.sin(elapsedTime * 3))
    sphereShadow.scale.y = Math.abs(Math.sin(elapsedTime * 3))
    sphereShadow.scale.z = Math.abs(Math.sin(elapsedTime * 3))
