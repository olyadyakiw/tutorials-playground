...
function App() {
    ...
    return (
        <div className="app">
            ...
            {selectedFriend && (
                <FormSplitBill key={selectedFriend.id} onSplitBill={handleSplitBill} selectedFriend={selectedFriend} />
            )}
        </div>
    )
}
...
function FriendsList({ friends, onSelection, selectedFriend }) {
    return (
        <ul>
            {friends.map(friend => (
                <Friend key={friend.id} selectedFriend={selectedFriend} onSelection={onSelection} friend={friend} />
            ))}
        </ul>
    )
}
...
function FormSplitBill({ selectedFriend, onSplitBill }) {
    ...
    return (
        <form className="form-split-bill" onSubmit={handleSubmit}>
            ...
            <label>🏷️ {selectedFriend.name}'s expences</label>
