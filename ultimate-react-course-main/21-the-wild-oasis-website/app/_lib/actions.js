...
export async function deleteReservation(bookingId) {
    ...
    if (!guestBookingsId.includes(bookingId)) throw new Error('You cant delete this booking')
...
export async function updateBooking(formData) {
    ...
    if (!guestBookingsId.includes(bookingId)) throw new Error('You cant update this booking')
